...
public class ChapterController {
    ...
    public ChapterResponse importChapter(@PathVariable String chapterId,
                                         @Valid @RequestBody ImportChapterRequest request) {
        return chapterService.importChapter(chapterId, request);
    }
}
